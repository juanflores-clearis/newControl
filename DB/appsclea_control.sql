...
-- Tiempo de generación: 23-01-2026 a las 12:43:45
-- Versión del servidor: 10.6.24-MariaDB-log
...
CREATE TABLE `access_control` (
  ...
  `technology_version` varchar(255) DEFAULT NULL,
  ...
  `ftp_access_development` text DEFAULT NULL,
...
CREATE TABLE `analysis_logs` (
  ...
  `virustotal_malicious_count` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
